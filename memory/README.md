...
This directory holds durable agent memory per host:

- `host/claude.md` for Claude-specific lessons
- `host/codex.md` for Codex-specific lessons
- `host/qwen.md` for Qwen-specific lessons
